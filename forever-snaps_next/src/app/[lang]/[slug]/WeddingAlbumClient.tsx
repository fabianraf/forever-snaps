        ...
        <main className="min-h-screen bg-[#AD9B99] p-6 flex flex-col items-center justify-center font-sans text-white">
            <div className="bg-[#C6B8B8] backdrop-blur-md p-8 rounded-3xl shadow-xl border border-white max-w-sm w-full text-center">
                <div className="flex justify-center mb-4 h-9 items-center">
                    {weddingNames ? <h1 className="text-3xl font-serif font-bold text-center">{weddingNames}</h1> : <div className="h-8 w-48 bg-[#e8d5d1] animate-pulse rounded-md"></div>}
                </div>
                ...
                <div className="my-2">
                    ...
                    <label htmlFor="cameraInput" className={`block w-full py-4 rounded-2xl text-white font-semibold cursor-pointer transition-all ${uploading ? 'bg-gray-400' : 'bg-gradient-to-b from-[#d8a9af] to-[#c79299] shadow-[0_14px_26px_rgba(200,140,150,0.26)] active:scale-95'}`}>
                        {uploading ? dictionary.ALBUM_PAGE.UPLOADING : dictionary.ALBUM_PAGE.TAKE_PHOTO}
                    </label>
                </div>
                ...
                <div className="my-2">
                    ...
                    <label htmlFor="galeryInput" className={`block w-full py-4 rounded-2xl text-black font-semibold cursor-pointer transition-all ${uploading ? 'bg-gray-400' : 'bg-white shadow-[0_14px_26px_rgba(200,140,150,0.26)] active:scale-95'}`}>
                        {uploading ? dictionary.ALBUM_PAGE.UPLOADING : dictionary.ALBUM_PAGE.UPLOAD_GALLERY}
                    </label>
                </div>

    ...
    <main className="min-h-screen bg-white p-6 flex flex-col items-center justify-center font-sans text-white">
      <div className="bg-[#FBF7F4] backdrop-blur-md p-8 rounded-3xl shadow-xl border border-[#826b602e] max-w-sm w-full text-center">
        <div className="my-6 p-4 bg-[#f7efe8] rounded-xl border border-[#826b602e]">
          ...
          <h4 className="text-[#7b6f6a] font-serif font-semibold text-lg">{DICTIONARY.ES.SUCCESS_PAGE.TITLE}</h4>
          <p className="text-[#7b6f6a] text-sm mt-1">{DICTIONARY.ES.SUCCESS_PAGE.SUBTITLE}</p>
        </div>
        ...
        <div className="my-2">
          ...
          <label
            ...
            className={`
                    ...
                    `}
          >
            {uploading ? DICTIONARY.ES.SUCCESS_PAGE.UPLOADING : DICTIONARY.ES.SUCCESS_PAGE.UPLOAD_ANOTHER}
          </label>
        </div>
        ...
        <div className="my-4">
          ...
          >
            {DICTIONARY.ES.SUCCESS_PAGE.VIEW_GALLERY}
          </button>
        </div>
      </div>
    </main>

    ...
    <main className="min-h-screen bg-white p-6 flex flex-col items-center justify-center font-sans text-white">
      <div className="bg-[#FBF7F4] backdrop-blur-md p-8 rounded-3xl shadow-xl border border-[#826b602e] max-w-sm w-full text-center">
        ...
        <div className="my-2">
          ...
          <label
            htmlFor="cameraInput"
            className={`block w-full py-4 rounded-2xl text-white font-semibold cursor-pointer transition-all ${uploading ? 'bg-gray-400' : 'bg-gradient-to-b from-[#d8a9af] to-[#c79299] shadow-[0_14px_26px_rgba(200,140,150,0.26)] active:scale-95'}`}
          >
